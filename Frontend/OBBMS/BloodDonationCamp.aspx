<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BloodDonationCamp.aspx.cs" Inherits="BloodDonationCamp" %>
   ...
   <div id="container" class="opacity">
    ...
    <table align="center"  width="70%">
     <tr>
        ...
        <td colspan="3">
        &nbsp;
            <center><h3>  Blood Donation Camp </h3></center>
        </td>
    </tr>
    ...
    <td>
        <asp:DropDownList ID="DropDownSelectDistrict" runat="server">
