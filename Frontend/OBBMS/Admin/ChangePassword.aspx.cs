...
public partial class ChangePassword : System.Web.UI.Page
{
    ...
    protected void Button_Click(object sender, EventArgs e)
    {
        ...
        string sql = "select * from TblAdminLogin where Id='"+ids.ToString()+"'";
        ...
        if (passwords == old_padd)
        {
            ...
            {
                string sql1 = "update TblAdminLogin set Password='" + TxtNew.Text + "' where Id='" + ids.ToString() + "'";
