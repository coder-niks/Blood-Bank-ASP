<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Blood_Detail.aspx.cs" Inherits="Admin_Blood_Detail" %>
...
<body background="../images/Back1.jpg">
    ...
    &nbsp;</div>
     <center><h3 align="center" 
         ...
         Add Blood Detail here...</h3></center>
   ...
   <table>
    ...
    <table  cellspacing="0" align="center"  border="0"
            ...
            style="background-image: url('../images/back%204.jpg'); height: 414px; width: 50%;">
    ...
    <td class="style1" 
        ...
        Blood Group</td>
    <td>
        <asp:DropDownList ID="DropDownBloodName" runat="server" Height="25px" 
            Width="253px">
        </asp:DropDownList>
    </td>
    <td>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
            ErrorMessage="Please Enter Blood Name" ControlToValidate="DropDownBloodName" 
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" 
            ...
            ControlToValidate="DropDownState" Display="Dynamic" ForeColor="White"></asp:RequiredFieldValidator>
    ...
    <td>
        <asp:DropDownList ID="DropDownDistrict" runat="server" AutoPostBack="True" 
            onselectedindexchanged="DropDownDistrict_SelectedIndexChanged" 
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
            ...
            ControlToValidate="DropDownDistrict" Display="Dynamic" ForeColor="White"></asp:RequiredFieldValidator>
     ...
     <tr>
    <td style="color: #00FFCC; font-variant: normal; font-style: oblique; font-weight: bolder; font-size: x-large;" 
             align="center">
        Blood Bank
    </td>
    <td>
        <asp:DropDownList ID="DropDownBloodBnk" runat="server" Height="25px" 
            Width="253px">
            <asp:ListItem>Select Blood Bank Name</asp:ListItem>
        </asp:DropDownList>
    </td>
    <td>
    
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
            ErrorMessage="Please Select Blood Blood Bank" 
            ControlToValidate="DropDownBloodBnk" Display="Dynamic" ForeColor="White"></asp:RequiredFieldValidator>
    ...
    <td style="font-size: x-large; font-weight: bolder; font-style: oblique; font-variant: normal; color: #00FFCC;" 
        ...
        Number Of Unit</td>
    <td>
        <asp:TextBox ID="TxtBottels" runat="server"  placeholder="Enter Units" TextMode="Number" Height="25px" 
            Width="253px">
    ...
    <td>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
            ErrorMessage="Please Enter Number of Bottels" ControlToValidate="TxtBottels" 
            Display="Dynamic" ForeColor="White"></asp:RequiredFieldValidator>
    ...
    <tr>
    <td style="color: #00FFCC; font-weight: bolder; font-style: oblique; font-variant: normal; font-size: x-large;" 
            align="center">
        Expiry Date
    </td>
    <td>
        <asp:TextBox ID="TxtDate" runat="server" TextMode="Date" Height="25px" 
            Width="253px"></asp:TextBox>
    </td>
    <td>
    
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
            ErrorMessage="Please Select Date" ControlToValidate="TxtDate" Display="Dynamic" 
    ...
    <td colspan="3" align="center">
        ...
        <asp:Button ID="BtnUpdate" runat="server" Text="Update" Height="30px" 
            Visible="False" onclick="BtnUpdate_Click" Width="90px" />
    </td>
    </tr>
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
     OnRowDeleting="delete_Data"
          DataKeyNames="Id" 
            ...
            CellPadding="4" AutoGenerateDeleteButton="True" Width="917px" 
