<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FindDonars.aspx.cs" Inherits="FindDonor" %>
...
.lastIndexOf("/") + 1);
    ...
    <td>
        ...
        <asp:DropDownList ID="DropDownBloodGroup" runat="server" 
            onselectedindexchanged="DropDownBloodGroup_SelectedIndexChanged">
...
<td colspan="2" align="center">
    ...
    <tr>
        <td align="center" colspan="2">
            <asp:GridView ID="GridView1" runat="server" BackColor="White" 
                ...
                <Columns>
                <asp:TemplateField HeaderText="Donar_Name">
                        ...
                        <ItemTemplate>
                       <a href="donars_Detail.aspx?a=<%# Eval("Id") %>">View Details</a>
                        </ItemTemplate>
                        </asp:TemplateField>
    ...
    <p>Copyright at V.B.P.C. All rights reserved 2016-17 // Design by <a href="">Vaibhav Naresh Bhavesh Vijay</a>.</p>
      ...
      <script src="style/js/scripts.js"></script></div>
    </form>
</body>
</html>
