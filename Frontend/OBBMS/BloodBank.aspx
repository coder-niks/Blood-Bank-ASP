<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BloodBank.aspx.cs" Inherits="BloodBank" %>
...
<div id="wrapper">
  <div id="header">
    ...
    <div>
    <div id="thumbs"> <a href="style/images/art/bg1.jpg">1</a> <a href="style/images/art/bg2.jpg">2</a> <a href="style/images/art/bg3.jpg">3</a> <a href="style/images/art/bg4.jpg">4</a> <a href="style/images/art/bg5.jpg">5</a> <a href="style/images/art/bg6.jpg">6</a> </div>
...
.lastIndexOf("/") + 1);
 ...
 <br />
   ...
   <center><h3><b>
    ...
    <i><b>Do donate blood if...</b></i><br /><br />
    <ul>
    <li>
   ...
   <i><b>Do not donate blood if you have any of these conditions...</i></b> <br /><br />
   <ul>
    <li>
