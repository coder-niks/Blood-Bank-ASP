<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Donars_Detail.aspx.cs" Inherits="Donars_Detail" %>
...
.lastIndexOf("/") + 1);
   ...
   <table align="center"  width="70%">
     <tr>
        ...
        <td colspan="3">
        &nbsp;
            <center><h3>  Donor Detail </h3></center>
        </td>
    </tr>
    <tr>
     </tr>
    <%
        ...
        con.ConnectionString = System.Configuration.ConfigurationManager.AppSettings["a"].ToString();
        string sql = "select * from TblBloodDonReg where Id='"+ids.ToString()+"'";
       cmd = new SqlCommand(sql,con);
        ...
        if (dr.Read())
        {
            Response.Write("<tr><td>Donar Name</td><td>"+dr[1]+"</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");
            
            Response.Write("<tr><td>Photo</td><td><image src='Admin/Dnr_Reg/" + dr[9].ToString() + "' height=100 width=100></td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");
            
            
            Response.Write("<tr><td>Email</td><td>" + dr[2] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");
            
            Response.Write("<tr><td>State</td><td>" + dr[11] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");
            
            Response.Write("<tr><td>District</td><td>" + dr[3] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");

            Response.Write("<tr><td>Address</td><td>" + dr[4] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");
            

            Response.Write("<tr><td>Blood Group</td><td>" + dr[5] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");

            Response.Write("<tr><td>Gender</td><td>" + dr[6] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");

            Response.Write("<tr><td>DOB</td><td>" + dr[7] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");

            Response.Write("<tr><td>Previous Blood Donation Date</td><td>" + dr[8] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");

            Response.Write("<tr><td>Phone</td><td>" + dr[10] + "</td></tr>");
            Response.Write("<tr><td colspan='2'><hr/></td></tr>");
